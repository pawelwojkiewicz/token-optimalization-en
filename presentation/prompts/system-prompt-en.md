...
2. Customer sentiment — one of: positive, neutral, negative
3. Confidence — "high" if you are very confident in your classification, "low" if the ticket is ambiguous
